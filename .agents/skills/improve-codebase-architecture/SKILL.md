...
Before generating, refactoring, or reviewing code in the `improve-codebase-architecture` domain, inspect these 5 critical parameters:
...
- **Activate when:** Use when Scans a codebase for deepening opportunities, architectural bottlenecks, tight coupling, and produces a prioritized visual improvement roadmap.
- **DO NOT activate when:** The task falls outside the `improve-codebase-architecture` domain or is managed by a different dedicated specialist.
