...
Before generating, refactoring, or reviewing code in the `project-idioms` domain, inspect these 5 critical parameters:
...
- **Activate when:** Use when >
- **DO NOT activate when:** The task falls outside the `project-idioms` domain or is managed by a different dedicated specialist.
