...
`;
    ...
    const bridges = [
        ...
        { path: path_1.default.join(targetDir, 'CLAUDE.md'), content: claudeRules, label: 'Claude root' },
        { path: path_1.default.join(targetDir, 'AGENTS.md'), content: codexRules, label: 'Codex / Multi-Agent' },
    ];
