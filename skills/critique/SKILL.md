...
Before generating, refactoring, or reviewing code in the `critique` domain, inspect these 5 critical parameters:
...
- **Activate when:** Use when Evaluate design quality with structured UX scoring, heuristic analysis, and persona-based usability checks. Use when asked to critique, evaluate, grade, or audit a UI design before implementation.
- **DO NOT activate when:** The task falls outside the `critique` domain or is managed by a different dedicated specialist.
