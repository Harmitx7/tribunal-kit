...
Before generating, refactoring, or reviewing code in the `trend-researcher` domain, inspect these 5 critical parameters:
...
- **Activate when:** Use when Creative muse and design trend analyzer for modern web/mobile interfaces.
- **DO NOT activate when:** The task falls outside the `trend-researcher` domain or is managed by a different dedicated specialist.
