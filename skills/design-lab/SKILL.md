---
name: design-lab
description: "Use when Interactive design exploration workflow: conduct interviews, generate variants, and refine UI designs through user feedback loops."
version: 5.0.0
...
Before generating, refactoring, or reviewing code in the `design-lab` domain, inspect these 5 critical parameters:
...
- **Activate when:** Use when Interactive design exploration workflow: conduct interviews, generate variants, and refine UI designs through user feedback loops.
- **DO NOT activate when:** The task falls outside the `design-lab` domain or is managed by a different dedicated specialist.
