---
name: rust-pro
description: Use when Master Rust 1.75+ with modern async patterns, ownership/borrowing, lifetimes, traits, error handling with thiserror/anyhow, async Tokio runtime, axum web framework, serde serialization, and systems programming. Use when building Rust services, CLI tools, WebAssembly, or performance-critical systems.
version: 5.0.0
...
Before generating, refactoring, or reviewing code in the `rust-pro` domain, inspect these 5 critical parameters:
...
- **Activate when:** Use when Master Rust 1.75+ with modern async patterns, ownership/borrowing, lifetimes, traits, error handling with thiserror/anyhow, async Tokio runtime, axum web framework, serde serialization, and systems programming. Use when building Rust services, CLI tools, WebAssembly, or performance-critical systems.
- **DO NOT activate when:** The task falls outside the `rust-pro` domain or is managed by a different dedicated specialist.
