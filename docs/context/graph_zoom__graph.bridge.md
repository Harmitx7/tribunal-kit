---
version: 2.0.0
bridge: 'tribunal-kit/.agent/scripts/graph_zoom.js <--> tribunal-kit/crates/core/src/commands/graph.rs'
relationship: 'Sibling / Peer Modules'
...
graph LR
    ...
    A -.->|"Sibling / Parallel"| B
```

## 📦 Shared Types & Interfaces

- _No identical type names detected between modules._
