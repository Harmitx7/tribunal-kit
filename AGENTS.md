<!--
  Tribunal Kit — OpenAI Codex & Universal Multi-Agent Governance
  Auto-generated by tribunal-kit.
  Repository: https://github.com/Harmitx7/tribunal-kit
-->
...
When executing tasks in specialized domains (e.g., `tdd-workflow`, `verification-before-completion`, `systematic-debugging`, `react-specialist`, `python-pro`), consult the relevant `SKILL.md` file before generating implementation code.
