...
- **Activate when:** Operating in tasks requiring Micro-delight generator for frontend interfaces. Suggests and implements subtle animations, playful transitions, and interaction polish across any frontend stack..
- **DO NOT activate when:** The task falls strictly outside whimsy-injector domain or belongs to a different dedicated specialist.
