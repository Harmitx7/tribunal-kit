...
- **Activate when:** Operating in tasks requiring >.
- **DO NOT activate when:** The task falls strictly outside project-idioms domain or belongs to a different dedicated specialist.
