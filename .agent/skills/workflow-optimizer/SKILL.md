...
- **Activate when:** Operating in tasks requiring Analyzes agent tool-calling patterns and task execution efficiency to suggest process improvements..
- **DO NOT activate when:** The task falls strictly outside workflow-optimizer domain or belongs to a different dedicated specialist.
