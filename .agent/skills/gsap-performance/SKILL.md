...
- **Activate when:** Operating in tasks requiring Official GSAP skill for performance — prefer transforms, avoid layout thrashing, will-change, batching. Use when optimizing GSAP animations, reducing jank, or when the user asks about animation performance, FPS, or smooth 60fps..
- **DO NOT activate when:** The task falls strictly outside gsap-performance domain or belongs to a different dedicated specialist.
