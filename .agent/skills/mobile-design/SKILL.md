...
- **Activate when:** Operating in tasks requiring Mobile-first design for iOS, Android, Foldables, React Native, Flutter. Touch interaction, haptics, 120Hz performance, on-device AI, spatial UI, Reanimated 3. Use when building mobile UI, animations, or cross-platform apps..
- **DO NOT activate when:** The task falls strictly outside mobile-design domain or belongs to a different dedicated specialist.
