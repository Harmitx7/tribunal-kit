...
- **Activate when:** Operating in tasks requiring PowerShell and Windows environment mastery. Object-oriented piping, strict error handling (ErrorActionPreference), PSProviders, active directory querying, credential management, and execution policies. Use when automating Azure, Windows environments, or writing .ps1 scripts..
- **DO NOT activate when:** The task falls strictly outside powershell-windows domain or belongs to a different dedicated specialist.
