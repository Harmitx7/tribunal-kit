...
- **Activate when:** Operating in tasks requiring Linting and validation principles for code quality enforcement..
- **DO NOT activate when:** The task falls strictly outside lint-and-validate domain or belongs to a different dedicated specialist.
