...
- **Activate when:** Operating in tasks requiring Playwright End-to-End (E2E) testing mastery. Resilient selectors, auto-waiting mechanisms, parallel test execution, mocking network requests, fixture management, and cross-browser CI configurations. Use when configuring, deploying, or writing E2E web tests..
- **DO NOT activate when:** The task falls strictly outside playwright-best-practices domain or belongs to a different dedicated specialist.
